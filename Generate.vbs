...
Private Sub BuildSolution ( SolutionFile )
  ...
  MSBuildCommand = """C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\MSBuild\Current\Bin\MSBuild.exe"" " & SolutionFile & " /t:Build /p:Configuration=Release /p:Platform=x86 /p:TargetFramework=v4.7.2 /fl /flp:logfile=Generate.log /nodeReuse:false"
...
'Patch the version in the .rc file
PatchRcFileVersion "RegSpy.rc", Assembly_Version

'Compile the projects
BuildSolution "RegSpy.vcxproj" 

'Copy output file
fso.CopyFile "Release\RegSpy.exe", OutputDirectory 
